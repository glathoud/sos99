...
apply the strategy proposed here:
 ...
 - at the cutoff point, by sorting the candidates already seen so far, and selecting a candidate that is better than at least 80% of the other candidates seen so far. Then that candidate itself can be used as a threshold:

 - after the cutoff, when seeing a new candidate, just compare it to that "threshold" candidate.\\
